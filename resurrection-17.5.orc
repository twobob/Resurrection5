; resurrection-17.5.orc
; 26/10/2021

; Resurrection-5.0 - a csound note rendering engine

; Will 18, 2002 - 2008, 2013, 2019-2021
...
#define makemakeOrbitForm(baseName'xaxis'yaxis'OP'OF'eTime)
#
...
#
	...
	$makemakeOrbitForm($layerNum$terrainType'x'y'OP'OF'$eTime)
